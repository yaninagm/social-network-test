...
public class FriendshipDeclineControllerTest {
    ...
    public void requestFriendshipPending() throws Exception{
        ...
        FriendshipRequest friendshipRequest = new FriendshipRequest("Mario", "Estefania", Constants.STATUS_DECLINED , date,  date);
        when(friendshipRequestRepository.save(any(FriendshipRequest.class))).thenReturn(friendshipRequest);
